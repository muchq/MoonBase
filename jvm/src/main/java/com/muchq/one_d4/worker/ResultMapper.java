 ...
 *
 * <p>Chess.com returns separate result strings for white and black: - "win" for the winning side -
 * "resigned", "checkmated", "timeout", "abandoned" for the losing side - "agreed", "repetition",
 * "stalemate", "insufficient", "50move", "timevsinsufficient" for draws
 *
 * <p>This class normalizes these to standard notation: "1-0", "0-1", "1/2-1/2", or "unknown".
 */
