...
public class GameReplayerTest {
    ...
    public void testCastlingKingside() {
        ...
        // FEN back rank: RNBQ1RK1 (Rook a1, Knight b1, Bishop c1, Queen d1, empty e1, Rook f1, King g1, empty h1)
    ...
    public void testStripsComments() {
        List<PositionContext> positions = replayer.replay(
                "1. e4 {Best by test} e5 {Solid reply} 2. Nf3");
    ...
    public void testAmbiguousMoveWithFile() {
        ...
        List<PositionContext> positions = replayer.replay(
                "1. e4 e5 2. Nf3 Nc6 3. Nc3 Nf6 4. Nd5 Nxd5 5. exd5 Nd4 6. Nxd4");
