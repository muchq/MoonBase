    ...
    <>
      <section className="hero">
        ...
        <p>
          ...
          auto-grader that runs entirely in your browser. Eighteen challenges climb from a toy
          expression language to two capstones: a query optimizer with a real cost model, and a
          width-aware code formatter. No compiler background assumed.
        </p>
        {firstOpen !== undefined && (
