...
This is a port of the Scala version located [here](../scraphics). Earlier version [here](https://gist.github.com/aaylward/5a0aabd1def217b1f1319a4695429adf).
...
bazel build //domains/graphics/libs/tracy_go

# Run the ray tracer
bazel run //domains/graphics/libs/tracy_go

# Run tests
bazel test //domains/graphics/libs/tracy_go:tracy_test
```
