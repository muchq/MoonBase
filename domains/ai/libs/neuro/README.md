...
import (
    "github.com/MoonBase/domains/ai/libs/neuro/network"
    "github.com/MoonBase/domains/ai/libs/neuro/layers"
    "github.com/MoonBase/domains/ai/libs/neuro/activations"
    "github.com/MoonBase/domains/ai/libs/neuro/loss"
    "github.com/MoonBase/domains/ai/libs/neuro/data"
    "github.com/MoonBase/domains/ai/libs/neuro/utils"
)
...
```bash
# Build the library
bazel build //domains/ai/libs/neuro:neuro

# Run tests
bazel test //domains/ai/libs/neuro/utils:utils_test
bazel test //domains/ai/libs/neuro/network:network_test

# Build all targets
bazel build //domains/ai/libs/neuro/...

# Test all targets
bazel test //domains/ai/libs/neuro/...
```
