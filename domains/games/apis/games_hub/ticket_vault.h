#ifndef DOMAINS_GAMES_APIS_GAMES_HUB_TICKET_VAULT_H
#define DOMAINS_GAMES_APIS_GAMES_HUB_TICKET_VAULT_H
...
/// credential. The default when GAMES_HUB_DB_URL is unset, and the test
