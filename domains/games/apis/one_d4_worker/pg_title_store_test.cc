...
// A failed save leaves the previous roster intact. The doomed row is a title
// one character past VARCHAR(10) under a username that sorts last, so it
// lands in a later batch than the good rows.
