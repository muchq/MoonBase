 ...
 * needs a player. {@code minGames} drops groups with fewer games than that, which is what makes a
 * score ranking readable: without it the top of the list is the sideline played once and won.
