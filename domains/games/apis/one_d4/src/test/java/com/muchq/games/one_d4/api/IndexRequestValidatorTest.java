...
public class IndexRequestValidatorTest {
  ...
  public void validRequest() {
    var request = new IndexRequest("hikaru", "CHESS_COM", "2024-03", "2024-03", null);
    assertThatCode(() -> validator.validate(request)).doesNotThrowAnyException();
  }

  @Test
  public void validRequest_multipleMonths() {
    var request = new IndexRequest("hikaru", "CHESS_COM", "2024-01", "2024-12", null);
    assertThatCode(() -> validator.validate(request)).doesNotThrowAnyException();
  }

  @Test
  public void rejectsNullPlayer() {
    var request = new IndexRequest(null, "CHESS_COM", "2024-03", "2024-03", null);
  ...
  public void rejectsBlankPlayer() {
    var request = new IndexRequest("  ", "CHESS_COM", "2024-03", "2024-03", null);
    assertThatThrownBy(() -> validator.validate(request))
        .isInstanceOf(IllegalArgumentException.class)
        .hasMessage("player is required");
  }
  ...
  public void rejectsNullPlatform() {
    var request = new IndexRequest("hikaru", null, "2024-03", "2024-03", null);
    assertThatThrownBy(() -> validator.validate(request))
        .isInstanceOf(IllegalArgumentException.class)
  ...
  public void rejectsUnsupportedPlatform() {
    var request = new IndexRequest("hikaru", "LICHESS", "2024-03", "2024-03", null);
    assertThatThrownBy(() -> validator.validate(request))
        .isInstanceOf(IllegalArgumentException.class)
  ...
  public void rejectsNullStartMonth() {
    var request = new IndexRequest("hikaru", "CHESS_COM", null, "2024-03", null);
    assertThatThrownBy(() -> validator.validate(request))
        .isInstanceOf(IllegalArgumentException.class)
  ...
  public void rejectsNullEndMonth() {
    var request = new IndexRequest("hikaru", "CHESS_COM", "2024-03", null, null);
    assertThatThrownBy(() -> validator.validate(request))
        .isInstanceOf(IllegalArgumentException.class)
  ...
  public void rejectsMalformedStartMonth() {
    var request = new IndexRequest("hikaru", "CHESS_COM", "March", "2024-03", null);
    assertThatThrownBy(() -> validator.validate(request))
        .isInstanceOf(IllegalArgumentException.class)
  ...
  public void rejectsMalformedEndMonth() {
    var request = new IndexRequest("hikaru", "CHESS_COM", "2024-03", "2024-13", null);
    assertThatThrownBy(() -> validator.validate(request))
        .isInstanceOf(IllegalArgumentException.class)
  ...
  public void rejectsStartAfterEnd() {
    var request = new IndexRequest("hikaru", "CHESS_COM", "2024-06", "2024-03", null);
    assertThatThrownBy(() -> validator.validate(request))
        .isInstanceOf(IllegalArgumentException.class)
  ...
  public void rejectsRangeOver12Months() {
    var request = new IndexRequest("hikaru", "CHESS_COM", "2023-01", "2024-02", null);
    assertThatThrownBy(() -> validator.validate(request))
        .isInstanceOf(IllegalArgumentException.class)
