...
public class PostgresPlayerIndexTest {
   ...
   * while excluding everyone else — through the real DAO. (At three unanalyzed rows the planner
   * seq-scans, so this pins predicate semantics and PG collation agreement, not index participation
   * — that is the plan test's job.)
   */
  @Test
