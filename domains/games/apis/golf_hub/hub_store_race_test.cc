...
TEST_F(HubStoreRaceFixture, DelayedFinishWakeReadsRetainedTerminalRow) {
  ...
  auto joined = ReceiveWithin<std::optional<moonbase::golf::GolfUpdate>>(
  ...
  ASSERT_TRUE(ReceiveWithin<std::optional<moonbase::golf::GolfUpdate>>(
  ...
  auto alice_ended = ReceiveWithin<std::optional<moonbase::golf::GolfUpdate>>(
