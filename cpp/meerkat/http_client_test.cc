...
TEST_F(HttpClientTest, MultipleSequentialRequestsWithHeaders) {
    ...
    std::cout << "First request completed: " << response1.success << ", " << response1.status_code << std::endl;
    ...
    std::cout << "Second request completed: " << response2.success << ", " << response2.status_code << std::endl;
