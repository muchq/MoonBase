...
HttpClientResponse HttpClient::make_request(const std::string& method, const std::string& url,
...
void HttpClient::handle_response(struct mg_connection* c, struct mg_http_message* hm, RequestContext* ctx) {
  // This method is not used in the current implementation
  // Logic is handled directly in event_handler
}

void HttpClient::handle_error(struct mg_connection* c, RequestContext* ctx, const std::string& error) {
  // This method is not used in the current implementation
  // Logic is handled directly in event_handler
}

std::unordered_map<std::string, std::string> HttpClient::parse_response_headers(struct mg_http_message* hm) {
  // This method is not used in the current implementation
  // Logic is handled directly in event_handler
  return {};
}

std::string HttpClient::build_request_headers(const std::unordered_map<std::string, std::string>& headers) {
  // This method is not used in the current implementation
  // Logic is handled directly in event_handler
  return "";
}
